...
{
    public class ExtendedNovaletExportGeneratorFunction : BaseFunction, ILambdaFunctionHandler
    {
        /// <summary>
        ...
        /// </summary>
        public ExtendedNovaletExportGeneratorFunction()
        {
        ...
        {
            context.Logger.LogLine("Generating extended Novalet export with urls");
            var createExportExtendedFileUseCase = ServiceProvider.GetService<ICreateNovaletExportExtendedUseCase>();

            var file = createExportExtendedFileUseCase.Execute().ConfigureAwait(false).GetAwaiter().GetResult();
        ...
        protected override void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ICreateNovaletExportExtendedUseCase, CreateNovaletExportExtendedUseCase>();
