...
module "housingregister_api_cloudwatch_dashboard" {
  source              = "git::git@github.com:LBHackney-IT/aws-hackney-common-terraform.git//tree/feature/dyanmic-zone-awareness/modules/cloudwatch/dashboards/api-dashboard"
