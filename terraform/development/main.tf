...
module "housingregister_api_cloudwatch_dashboard" {
  source              = "git::git@github.com:LBHackney-IT/aws-hackney-common-terraform.git//modules/cloudwatch/dashboards/api-dashboard?ref=feature/dyanmic-zone-awareness"
